PRD: Job Pilot — High-Volume Job Application Assistant
1. Summary
Job Pilot helps a job seeker apply to ~50 relevant jobs/day by combining job aggregation, AI-tailored resume/cover-letter generation, and a fast review-and-submit workflow — without violating job board terms of service or spamming employers with generic copies.
